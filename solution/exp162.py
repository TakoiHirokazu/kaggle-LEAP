...
data_fe5 = "163"
data_path5 = OUTPUT_DIR / "fe" / \
    f"fe{data_fe5}" / f"fe{data_fe5}_data_list.parquet"

data_fe6 = "172"
data_path6 = OUTPUT_DIR / "fe" / \
    f"fe{data_fe6}" / f"fe{data_fe6}_data_list.parquet"
# =====================
# Funcsion
# =====================
...
class LeapRnnModel(nn.Module):
    def __init__(
            ...
            numeraical_linear_size=64 * 2,
            input_numerical_size2=17,
            numeraical_linear_size2=64 * 2,
            model_size=256 * 4,
            linear_out=256,
            out_size1=6,
            out_size2=8):
...
data_list5 = pd.read_parquet(data_path5)
data_list6 = pd.read_parquet(data_path6)
data_list = pd.concat([data_list1, data_list2,
                       data_list3, data_list4, data_list5,
                       data_list6],
